...
import {BasketballLeague} from "../../basketball/leagues/entities/basketball-league.entity";

@Index('country_slug_idx', ['slug'], {})
@Entity('country', { schema: 'public' })
export class CountryBasketballEntity {
  ...
  @OneToMany(() => BasketballLeague, (league) => league.country)
