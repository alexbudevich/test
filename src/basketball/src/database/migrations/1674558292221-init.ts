...
export class init1674558292221 implements MigrationInterface {
    name = 'init1674558292221'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "bookmaker" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "logo" text, "rank" numeric, "user_rank" numeric, "avg_payout" numeric, "payout_speed" numeric, "overview" json, "bonus_offer" json, "provider_id" character varying(50), "timestamp" TIMESTAMP WITH TIME ZONE DEFAULT now(), "slug" text, "s3_logo_url" text, "rating" numeric, "aff_link" text, "high_payout" boolean, "live_stream" boolean, "bet_builder" boolean, "cash_out" boolean, "live_chat" boolean, "casino" boolean, "poker" boolean, "mobile" boolean, "android" boolean, "ios" boolean, "support_email" boolean, "support_phone" boolean, "description" text, "country_id" integer, CONSTRAINT "PK_a53596285659d31632a10cc6d6e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "bookmaker_slug_idx" ON "bookmaker" ("slug") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "pk_1" ON "bookmaker" ("id") `);
        await queryRunner.query(`CREATE TABLE "sport" ("id" SERIAL NOT NULL, "name" character varying(50), "slug" text, CONSTRAINT "PK_c67275331afac347120a1032825" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "sport_slug_idx" ON "sport" ("slug") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "sport_pkey" ON "sport" ("id") `);
        await queryRunner.query(`CREATE TABLE "odd" ("id" SERIAL NOT NULL, "match_id" integer, "bookmaker_id" integer, "name" character varying(50), "value" character varying(50), "handicap" integer, "is_main" boolean, "is_suspended" boolean, "odd" numeric, "provider_id" character varying(50), "timestamp" TIMESTAMP WITH TIME ZONE DEFAULT now(), "sport_type_id" integer, CONSTRAINT "PK_0c8cc40afd45ec76ef50e32274d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "odd_match_id_idx" ON "odd" ("match_id") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "odd_pkey" ON "odd" ("id") `);
        await queryRunner.query(`CREATE INDEX "odd_match_id_bookmaker_id_idx" ON "odd" ("bookmaker_id", "match_id") `);
        await queryRunner.query(`CREATE INDEX "odd_bookmaker_id_idx" ON "odd" ("bookmaker_id") `);
        await queryRunner.query(`CREATE TABLE "match" ("id" SERIAL NOT NULL, "date" TIMESTAMP WITH TIME ZONE, "match_score_home" smallint, "match_score_away" smallint, "elapsed" smallint, "status_short" character varying(5), "status_long" character varying, "statistics" json, "is_live" boolean, "provider_id" character varying(50), "slug" text, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "league_id" integer, "sport_type_id" integer, "team_away_id" integer, "team_home_id" integer, CONSTRAINT "PK_92b6c3a6631dd5b24a67c69f69d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "match_slug_idx" ON "match" ("slug") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "match_pkey" ON "match" ("id") `);
        await queryRunner.query(`CREATE TABLE "team" ("id" SERIAL NOT NULL, "name" character varying(50), "code" character varying(50), "logo_url" text, "provider_id" character varying(50), "founded" smallint, "national" boolean, "timestamp" TIMESTAMP WITH TIME ZONE DEFAULT now(), "slug" text, "s3_logo_url" text, "country_id" integer, "league_id" integer, "sport_type_id" integer, CONSTRAINT "PK_f57d8293406df4af348402e4b74" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "team_slug_idx" ON "team" ("slug") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "team_pkey" ON "team" ("id") `);
        await queryRunner.query(`CREATE TABLE "player" ("id" SERIAL NOT NULL, "name" character varying(50), "firstname" character varying(50), "lastname" character varying(50), "age" smallint, "birth" date, "place" character varying(50), "nationality" character varying(50), "is_injured" boolean, "photo_url" text, "statistics" json, "is_coach" boolean, "career" json, "provider_id" character varying(50), "height" text, "weight" text, "timestamp" TIMESTAMP WITH TIME ZONE DEFAULT now(), "slug" text, "s3_photo_url" text, "country_id" integer, "sport_type_id" integer, CONSTRAINT "PK_65edadc946a7faf4b638d5e8885" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "player_slug_idx" ON "player" ("slug") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "player_pkey" ON "player" ("id") `);
        await queryRunner.query(`CREATE TABLE "country" ("id" SERIAL NOT NULL, "name" character varying(50), "code" character varying(50), "flag_url" text, "slug" text, "s3_flag_url" text, CONSTRAINT "PK_bf6e37c231c4f4ea56dcd887269" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "country_slug_idx" ON "country" ("slug") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "country_pkey" ON "country" ("id") `);
        await queryRunner.query(`CREATE TABLE "season" ("id" SERIAL NOT NULL, "year" character varying, "start" character varying(50), "end" character varying(50), "timestamp" TIMESTAMP WITH TIME ZONE DEFAULT now(), "slug" text, CONSTRAINT "PK_8ac0d081dbdb7ab02d166bcda9f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "season_slug_idx" ON "season" ("slug") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "season_pkey" ON "season" ("id") `);
        await queryRunner.query(`CREATE TABLE "league" ("id" SERIAL NOT NULL, "name" text, "type" character varying(50), "logo_url" text, "provider_id" character varying(50), "timestamp" TIMESTAMP WITH TIME ZONE DEFAULT now(), "standings" json, "slug" text, "s3_logo_url" text, "description" text, "season_start" TIMESTAMP WITH TIME ZONE, "season_end" TIMESTAMP WITH TIME ZONE, "country_id" integer, "sport_type_id" integer, CONSTRAINT "PK_0bd74b698f9e28875df738f7864" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "league_slug_idx" ON "league" ("slug") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "league_pkey" ON "league" ("id") `);
        await queryRunner.query(`CREATE TABLE "week" ("id" SERIAL NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE, "is_current" boolean, "league_id" integer, "season_id" integer, CONSTRAINT "PK_1f85dfadd5f363a1d0bce2b9664" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "week_pkey" ON "week" ("id") `);
        await queryRunner.query(`CREATE TABLE "team_player" ("player_id" integer NOT NULL, "team_id" integer NOT NULL, CONSTRAINT "PK_a117e0cf67831271a440b554fe0" PRIMARY KEY ("player_id", "team_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "league_season" ("league_id" integer NOT NULL, "season_id" integer NOT NULL, CONSTRAINT "PK_3b0d1bb652983326dee08ed2907" PRIMARY KEY ("league_id", "season_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "odd" ADD CONSTRAINT "FK_9ac43018bc2ccef004a553f56a9" FOREIGN KEY ("sport_type_id") REFERENCES "sport"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "match" ADD CONSTRAINT "FK_aa32fa685d5628fdb0e1f39ec1c" FOREIGN KEY ("sport_type_id") REFERENCES "sport"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "team" ADD CONSTRAINT "FK_a0187e96dfe350636f3f406b889" FOREIGN KEY ("sport_type_id") REFERENCES "sport"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "player" ADD CONSTRAINT "FK_384073bf7e1a0f7e28918e3528e" FOREIGN KEY ("sport_type_id") REFERENCES "sport"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "league" ADD CONSTRAINT "FK_9070b9fb1b1e14af610ae4ce312" FOREIGN KEY ("sport_type_id") REFERENCES "sport"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "league" DROP CONSTRAINT "FK_9070b9fb1b1e14af610ae4ce312"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."odd_match_id_bookmaker_id_idx"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."sport_pkey"`);
        await queryRunner.query(`DROP INDEX "public"."sport_slug_idx"`);
