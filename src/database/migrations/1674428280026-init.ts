...
export class init1674428280026 implements MigrationInterface {
  name = 'init1674428280026';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "team_player" ("player_id" integer NOT NULL, "team_id" integer NOT NULL, CONSTRAINT "PK_a117e0cf67831271a440b554fe0" PRIMARY KEY ("player_id", "team_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_a6f4fcfc1c7229fbcb67c6fb4b" ON "team_player" ("player_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ac195c6f3ba8962bd9f11cc400" ON "team_player" ("team_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "league_season" ("league_id" integer NOT NULL, "season_id" integer NOT NULL, CONSTRAINT "PK_3b0d1bb652983326dee08ed2907" PRIMARY KEY ("league_id", "season_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_22620c42e0750778225744ae50" ON "league_season" ("league_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_60a080e4eb5604bc67fe37a3d0" ON "league_season" ("season_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "team_player" ADD CONSTRAINT "FK_a6f4fcfc1c7229fbcb67c6fb4b2" FOREIGN KEY ("player_id") REFERENCES "player"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "league_season" ADD CONSTRAINT "FK_22620c42e0750778225744ae505" FOREIGN KEY ("league_id") REFERENCES "league"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "league_season" ADD CONSTRAINT "FK_60a080e4eb5604bc67fe37a3d0e" FOREIGN KEY ("season_id") REFERENCES "season"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_60a080e4eb5604bc67fe37a3d0"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_22620c42e0750778225744ae50"`,
    );
    await queryRunner.query(`DROP TABLE "league_season"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ac195c6f3ba8962bd9f11cc400"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a6f4fcfc1c7229fbcb67c6fb4b"`,
    );
