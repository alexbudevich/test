...
export class addedBasketball1675058459753 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "new_league_season" ("league_id" integer NOT NULL, "season_id" integer NOT NULL, CONSTRAINT "PK_5bf0387f39e81a8afd28ae819a4" PRIMARY KEY ("league_id", "season_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_9a93fe65000dc6aa136019201e" ON "new_league_season" ("league_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_63ebc300f19dc2da936280f672" ON "new_league_season" ("season_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "new_league_season" ADD CONSTRAINT "FK_63ebc300f19dc2da936280f6729" FOREIGN KEY ("season_id") REFERENCES "season"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "new_league_season" DROP CONSTRAINT "FK_63ebc300f19dc2da936280f6729"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_63ebc300f19dc2da936280f672"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9a93fe65000dc6aa136019201e"`);
        await queryRunner.query(`DROP TABLE "new_league_season"`);
